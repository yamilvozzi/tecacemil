...
export default function App() {
  ...
  // Aplicar tema claro para Celeste, oscuro para Yamil
  // Se aplica en <html> para que afecte a todos los elementos incluyendo body
  useEffect(() => {
  ...
  if (loading) {
    return (
      <div style={{
        ...
        justifyContent: 'center', color: 'var(--text-muted)', fontFamily: 'var(--font)'
      }}>
        Cargando…
      </div>
    )
