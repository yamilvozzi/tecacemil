        ...
        {!loading && settlements.length === 0 ? (
          ...
          <div className="card" style={{ padding: 0 }}>
            <div className="table-wrapper">
              <table>
                <thead>
                  <tr><th>Fecha</th><th>De</th><th>Para</th><th>Nota</th><th style={{ textAlign: 'right' }}>Monto</th><th></th></tr>
                </thead>
                <tbody>
                  {settlements.map(st => {
              ...
              <table>
                <thead>
                  <tr>
                    ...
                    <th>Medio</th><th>Pagó</th><th style={{ textAlign: 'right' }}>Monto</th>
                  </tr>
                </thead>
                <tbody>
                  {sharedExpenses.map(tx => (
                    <tr key={tx.id}>
                      ...
                      <td style={{ color: 'var(--text-muted)', fontSize: '0.82rem' }}>{tx.category}</td>
                      <td>{pmTag(tx.payment_method)}</td>
